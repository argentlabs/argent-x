const texts = {
  ...
  account: {
    ...
    argentShield: {
      ...
      emailInUse:
        /This address is associated with accounts from another seedphrase[.,]?\s*Please enter another email address to continue[.,]?/,
    },
  ...
  wallet: {
    ...
    //third screen
    banner3: "Create a password",
    desc3: "This is used to protect and unlock your wallet",
    password: "Password",
    repeatPassword: "Repeat password",
    createWallet: "Create wallet",
    //fourth screen
    banner4: /Your (smart )?account is ready!/,
    download: "Download the mobile app",
    twitter: "Follow us on X",
    dapps: "Explore Starknet apps",
    finish: "Finish",
  },
  settings: {
    account: {
    ...
    preferences: {
      ...
      hideTokens: "Hidden and spam tokens",
