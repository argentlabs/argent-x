...
test("generate Stark Pair", () => {
  ...
  expect(starkPair5.pubKey).toBe(
    "0x5c7c65bfda7a85af0681c85c9c440f0aa6825feef6f9c96e55fb2ce08c8d4bc",
  )

  const starkPair7 = getStarkPair(7, secret, baseDerivationPath)
  expect(starkPair7.pubKey).toBe(
    "0x605d5a0ece3b316f0d72221228acb7f01dcb34db74e0c02790db156741f5a86",
  )
})
...
test("grindKey", () => {
  ...
  const res = encode.addHexPrefix(grindKey(privateKey))
  expect(res).toBe(
