...
> = {
  ...
  contract_is_black_listed: {
    ...
    description: (reason) =>
      `You are using a smart contract that is on our unsafe list for the following reason: ${reason}. We recommend that you reject the transaction.`,
  },
  recipient_is_black_listed: {
    title: "Recipient on unsafe list",
    description: (reason) =>
      `You are sending to an unsafe contract that is blacklisted for the the following reason: ${reason}.`,
  },
  spender_is_black_listed: {
    title: "Spender on unsafe list",
    description: (reason) =>
      `You are allowing an unsafe contract to access your funds. We deem this contract unsafe for the following reason: ${reason}.`,
  },
  ...
  src_token_black_listed: {
    ...
    description: () =>
      "You are selling an unsafe token. Be aware of the risks.",
  },
  ...
  domain_is_black_listed: {
    title: "Use of a blacklisted domain",
    description: () =>
      "You are currently on an unsafe domain. Be aware of the risks.",
  },
  similar_to_existing_dapp_url: {
    title: "Similar to an existing dapp",
    description: () =>
      "You are currently on an unsafe domain. Be aware of the risks.",
  },
}
