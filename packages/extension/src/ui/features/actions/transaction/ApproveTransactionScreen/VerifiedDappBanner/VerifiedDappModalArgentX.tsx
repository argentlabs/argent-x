...
import { VerifiedDappBannerArgentXProps } from "."
...
interface VerifiedDappModalArgentXProps extends VerifiedDappBannerArgentXProps {
  isOpen: boolean
  onClose: () => void
}
...
export const VerifiedDappModalArgentX: FC<VerifiedDappModalArgentXProps> = ({
  dapp,
  isOpen,
  onClose,
}) => {
