...
import { getChainIdFromNetworkId } from "../../network/utils"
import {
...
} from "../utils/pendingMultisig"
import { getMultisigTransactionType } from "../utils/getMultisigTransactionType"
...
export class MultisigWorker {
  constructor(
    ...
    void this.scheduleService.every(RefreshInterval.FAST, { id })
  }
