import { mergeArrayStableWith } from "../array"

describe("mergeArrayStableWith", () => {
  describe("primitive values", () => {
    test("should merge 2 arrays", async () => {
      const arr1 = [1, 2, 3]
      const arr2 = [4, 5, 6]
      const result = mergeArrayStableWith(arr1, arr2)
      expect(result).toEqual([1, 2, 3, 4, 5, 6])
    })
    test("should merge 2 arrays with duplicates in each", async () => {
      const arr1 = [1, 2, 3, 3]
      const arr2 = [4, 5, 6, 6]
      const result = mergeArrayStableWith(arr1, arr2)
      expect(result).toEqual([1, 2, 3, 4, 5, 6])
    })
    test("should merge 2 arrays with duplicates", async () => {
      const arr1 = [1, 2, 3]
      const arr2 = [3, 4, 5, 6, 6]
      const result = mergeArrayStableWith(arr1, arr2)
      expect(result).toEqual([1, 2, 3, 4, 5, 6])
    })
    test("should merge array with empty array", async () => {
      const arr1 = [1, 2, 3]
      const arr2: typeof arr1 = []
      const result = mergeArrayStableWith(arr1, arr2)
      expect(result).toEqual([1, 2, 3])
    })
    test("should merge empty array with array", async () => {
      const arr1 = [1, 2, 3]
      const arr2: typeof arr1 = []
      const result = mergeArrayStableWith(arr2, arr1)
      expect(result).toEqual([1, 2, 3])
    })
    test("should merge empty array with empty array", async () => {
      const arr1: unknown[] = []
      const arr2: typeof arr1 = []
      const result = mergeArrayStableWith(arr1, arr2)
